...
class AssembleEnv(object):
    def __init__(self, dt = 0., max_steps = 1000,
        ...
        self.task_name = "two-axis socket (3D printing Part 1)"
        #|o|o|                             observations: 2
        ...
        # print(self.img_obs_offsetX)
        # print(self.img_obs_offsetX_rand)
    ...
    def reset(self, isAddError=True, is_drag_mode=False, error_scale_pos=1, error_scale_ort=1,
              initial_pos_ort=np.array([-93.55e-3, -531.03e-3, 94e-3, 0, -3.1415, 0])):
